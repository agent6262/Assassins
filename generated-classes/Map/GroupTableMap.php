...
class GroupTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Permissions', 'Rank', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'permissions', 'rank', ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID, GroupTableMap::COL_NAME, GroupTableMap::COL_PERMISSIONS, GroupTableMap::COL_RANK, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'permissions', 'rank', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Permissions' => 2, 'Rank' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'permissions' => 2, 'rank' => 3, ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID => 0, GroupTableMap::COL_NAME => 1, GroupTableMap::COL_PERMISSIONS => 2, GroupTableMap::COL_RANK => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'permissions' => 2, 'rank' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('rank', 'Rank', 'TINYINT', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('AutoJoinedGame', '\\Game', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':auto_join_group_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'AutoJoinedGames', false);
...
), 'CASCADE', null, 'PlayerGroups', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Setting', '\\Setting', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':auto_join_group_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'Settings', false);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupTableMap::COL_PERMISSIONS);
            $criteria->addSelectColumn(GroupTableMap::COL_RANK);
        } else {
