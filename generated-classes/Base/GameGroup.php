...
/**
 * Base class that represents a row from the 'game_groups' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class GameGroup implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GameGroupTableMap';
    ...
    /**
     * Initializes internal state of Base\GameGroup object.
     */
    ...
    /**
     * Compares this with another <code>GameGroup</code> instance.  If
     * <code>obj</code> is an instance of <code>GameGroup</code>, delegates to
     * <code>equals(GameGroup)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GameGroup The current object, for fluid interface
     */
     ...
     * @return $this|\GameGroup The current object (for fluent API support)
     */
    public function setGameId($v)
    {
        ...
        if ($this->game_id !== $v) {
            $this->game_id = $v;
            $this->modifiedColumns[GameGroupTableMap::COL_GAME_ID] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[GameGroupTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GameGroupTableMap::translateFieldName('GameId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->game_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GameGroupTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = GameGroupTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\GameGroup'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGameGroupQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GameGroup::setDeleted()
     * @see GameGroup::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGameGroupQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GameGroupTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GameGroupTableMap::COL_GAME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`game_id`';
        }
        if ($this->isColumnModified(GameGroupTableMap::COL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }

        $sql = sprintf(
            'INSERT INTO `game_groups` (%s) VALUES (%s)',
    ...
    {
        $pos = GameGroupTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GameGroup'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GameGroup'][$this->hashCode()] = true;
        $keys = GameGroupTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GameGroupTableMap::COL_GAME_ID)) {
            $criteria->add(GameGroupTableMap::COL_GAME_ID, $this->game_id);
        }
        if ($this->isColumnModified(GameGroupTableMap::COL_GROUP_ID)) {
            $criteria->add(GameGroupTableMap::COL_GROUP_ID, $this->group_id);
        }
    ...
    {
        $criteria = ChildGameGroupQuery::create();
        $criteria->add(GameGroupTableMap::COL_GAME_ID, $this->game_id);
        $criteria->add(GameGroupTableMap::COL_GROUP_ID, $this->group_id);
    ...
    public function hashCode()
    {
        ...
        //relation game_groups_fk_b81797 to table games
        ...
        //relation game_groups_fk_59fbd5 to table groups
    ...
    {
        return (null === $this->getGameId()) && (null === $this->getGroupId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GameGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GameGroup Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroup->addGameGroups($this);
             */
        }
    ...
    {
        if (null !== $this->aGame) {
            $this->aGame->removeGameGroup($this);
        }
        if (null !== $this->aGroup) {
            $this->aGroup->removeGameGroup($this);
        }
        $this->game_id = null;
        $this->group_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(GameGroupTableMap::DEFAULT_STRING_FORMAT);
    }
