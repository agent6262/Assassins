...
abstract class Setting implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the presets_id field.
     * 
     * @var        int
     */
    protected $presets_id;
    ...
    /**
     * Get the [presets_id] column value.
     * 
     * @return int
     */
    public function getPresetsId()
    {
        return $this->presets_id;
    }
    ...
    /**
     * Set the value of [presets_id] column.
     * 
     * @param int $v new value
     * @return $this|\Setting The current object (for fluent API support)
     */
    public function setPresetsId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->presets_id !== $v) {
            $this->presets_id = $v;
            $this->modifiedColumns[SettingTableMap::COL_PRESETS_ID] = true;
        }
    ...
    public function setInvite($v)
    {
        ...
        if ($this->invite !== $v) {
            $this->invite = $v;
            $this->modifiedColumns[SettingTableMap::COL_INVITE] = true;
        }
    ...
    public function setRequestInvite($v)
    {
        ...
        if ($this->request_invite !== $v) {
            ...
            $this->modifiedColumns[SettingTableMap::COL_REQUEST_INVITE] = true;
        }
    ...
    public function setAutoJoinGroupId($v)
    {
        ...
        if ($this->auto_join_group_id !== $v) {
            ...
            $this->modifiedColumns[SettingTableMap::COL_AUTO_JOIN_GROUP_ID] = true;
        }
    ...
    public function setAutoPlace($v)
    {
        ...
        if ($this->auto_place !== $v) {
            $this->auto_place = $v;
            $this->modifiedColumns[SettingTableMap::COL_AUTO_PLACE] = true;
        }
    ...
    public function setDuplicateGameOnComplete($v)
    {
        ...
        if ($this->duplicate_game_on_complete !== $v) {
            ...
            $this->modifiedColumns[SettingTableMap::COL_DUPLICATE_GAME_ON_COMPLETE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SettingTableMap::translateFieldName('PresetsId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->presets_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SettingTableMap::translateFieldName('Invite', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invite = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SettingTableMap::translateFieldName('RequestInvite', TableMap::TYPE_PHPNAME, $indexType)];
            $this->request_invite = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SettingTableMap::translateFieldName('AutoJoinGroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->auto_join_group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SettingTableMap::translateFieldName('AutoPlace', TableMap::TYPE_PHPNAME, $indexType)];
            $this->auto_place = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SettingTableMap::translateFieldName('DuplicateGameOnComplete', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = SettingTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aPreset !== null && $this->presets_id !== $this->aPreset->getId()) {
            $this->aPreset = null;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SettingTableMap::COL_PRESETS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`presets_id`';
        }
        if ($this->isColumnModified(SettingTableMap::COL_INVITE)) {
            $modifiedColumns[':p' . $index++]  = '`invite`';
        }
        if ($this->isColumnModified(SettingTableMap::COL_REQUEST_INVITE)) {
            $modifiedColumns[':p' . $index++]  = '`request_invite`';
        }
        if ($this->isColumnModified(SettingTableMap::COL_AUTO_JOIN_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`auto_join_group_id`';
        }
        if ($this->isColumnModified(SettingTableMap::COL_AUTO_PLACE)) {
            $modifiedColumns[':p' . $index++]  = '`auto_place`';
        }
        if ($this->isColumnModified(SettingTableMap::COL_DUPLICATE_GAME_ON_COMPLETE)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`presets_id`':                        
                        $stmt->bindValue($identifier, $this->presets_id, PDO::PARAM_INT);
                        break;
                    case '`invite`':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getPresetsId(),
            $keys[1] => $this->getInvite(),
            $keys[2] => $this->getRequestInvite(),
            $keys[3] => $this->getAutoJoinGroupId(),
            $keys[4] => $this->getAutoPlace(),
            $keys[5] => $this->getDuplicateGameOnComplete(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setPresetsId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setInvite($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setRequestInvite($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAutoJoinGroupId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setAutoPlace($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDuplicateGameOnComplete($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingTableMap::COL_PRESETS_ID)) {
            $criteria->add(SettingTableMap::COL_PRESETS_ID, $this->presets_id);
        }
        if ($this->isColumnModified(SettingTableMap::COL_INVITE)) {
            $criteria->add(SettingTableMap::COL_INVITE, $this->invite);
        }
        if ($this->isColumnModified(SettingTableMap::COL_REQUEST_INVITE)) {
            $criteria->add(SettingTableMap::COL_REQUEST_INVITE, $this->request_invite);
        }
        if ($this->isColumnModified(SettingTableMap::COL_AUTO_JOIN_GROUP_ID)) {
            $criteria->add(SettingTableMap::COL_AUTO_JOIN_GROUP_ID, $this->auto_join_group_id);
        }
        if ($this->isColumnModified(SettingTableMap::COL_AUTO_PLACE)) {
            $criteria->add(SettingTableMap::COL_AUTO_PLACE, $this->auto_place);
        }
        if ($this->isColumnModified(SettingTableMap::COL_DUPLICATE_GAME_ON_COMPLETE)) {
            $criteria->add(SettingTableMap::COL_DUPLICATE_GAME_ON_COMPLETE, $this->duplicate_game_on_complete);
        }
    ...
    {
        $validPk = null !== $this->getPresetsId();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation settings_fk_e4e4e0 to table presets
    ...
    /**
     * Generic method to set the primary key (presets_id column).
     *
    ...
    {
        $copyObj->setPresetsId($this->getPresetsId());
    ...
    public function getAutoJoinGroup(ConnectionInterface $con = null)
    {
        if ($this->aAutoJoinGroup === null && ($this->auto_join_group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAutoJoinGroup->addSettings($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setPresetsId(NULL);
        } else {
            $this->setPresetsId($v->getId());
        }
    ...
    {
        if ($this->aPreset === null && ($this->presets_id !== null)) {
            $this->aPreset = ChildPresetQuery::create()->findPk($this->presets_id, $con);
            // Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
            $this->aPreset->setSetting($this);
        }
    ...
    {
        if (null !== $this->aAutoJoinGroup) {
            $this->aAutoJoinGroup->removeSetting($this);
        }
        if (null !== $this->aPreset) {
            $this->aPreset->removeSetting($this);
        }
        $this->presets_id = null;
        $this->invite = null;
