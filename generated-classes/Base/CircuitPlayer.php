...
/**
 * Base class that represents a row from the 'circuit_players' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class CircuitPlayer implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CircuitPlayerTableMap';
    ...
    /**
     * Initializes internal state of Base\CircuitPlayer object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CircuitPlayer</code> instance.  If
     * <code>obj</code> is an instance of <code>CircuitPlayer</code>, delegates to
     * <code>equals(CircuitPlayer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CircuitPlayer The current object, for fluid interface
     */
     ...
     * @return $this|\CircuitPlayer The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_ID] = true;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_ACTIVE] = true;
        }
    ...
    public function setGameId($v)
    {
        ...
        if ($this->game_id !== $v) {
            $this->game_id = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_GAME_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setTargetId($v)
    {
        ...
        if ($this->target_id !== $v) {
            $this->target_id = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_TARGET_ID] = true;
        }
    ...
    public function setPay($v)
    {
        ...
        if ($this->pay !== $v) {
            $this->pay = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_PAY] = true;
        }
    ...
    public function setMoneySpent($v)
    {
        ...
        if ($this->money_spent !== $v) {
            $this->money_spent = $v;
            $this->modifiedColumns[CircuitPlayerTableMap::COL_MONEY_SPENT] = true;
        }
    ...
    public function setDateAssigned($v)
    {
        ...
        if ($this->date_assigned !== null || $dt !== null) {
            if ($this->date_assigned === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_assigned->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CircuitPlayerTableMap::COL_DATE_ASSIGNED] = true;
            }
    ...
    public function setDateCompleted($v)
    {
        ...
        if ($this->date_completed !== null || $dt !== null) {
            if ($this->date_completed === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_completed->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CircuitPlayerTableMap::COL_DATE_COMPLETED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CircuitPlayerTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CircuitPlayerTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            $this->active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CircuitPlayerTableMap::translateFieldName('GameId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->game_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CircuitPlayerTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->player_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CircuitPlayerTableMap::translateFieldName('TargetId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->target_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CircuitPlayerTableMap::translateFieldName('Pay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pay = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CircuitPlayerTableMap::translateFieldName('MoneySpent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->money_spent = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CircuitPlayerTableMap::translateFieldName('DateAssigned', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_assigned = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CircuitPlayerTableMap::translateFieldName('DateCompleted', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = CircuitPlayerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CircuitPlayer'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCircuitPlayerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CircuitPlayer::setDeleted()
     * @see CircuitPlayer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCircuitPlayerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CircuitPlayerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`active`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_GAME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`game_id`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_PLAYER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`player_id`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_TARGET_ID)) {
            $modifiedColumns[':p' . $index++]  = '`target_id`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_PAY)) {
            $modifiedColumns[':p' . $index++]  = '`pay`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_MONEY_SPENT)) {
            $modifiedColumns[':p' . $index++]  = '`money_spent`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_DATE_ASSIGNED)) {
            $modifiedColumns[':p' . $index++]  = '`date_assigned`';
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_DATE_COMPLETED)) {
            $modifiedColumns[':p' . $index++]  = '`date_completed`';
        }

        $sql = sprintf(
            'INSERT INTO `circuit_players` (%s) VALUES (%s)',
    ...
    {
        $pos = CircuitPlayerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CircuitPlayer'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CircuitPlayer'][$this->hashCode()] = true;
        $keys = CircuitPlayerTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[5] => $this->getPay(),
            $keys[6] => $this->getMoneySpent(),
            $keys[7] => $this->getDateAssigned(),
            $keys[8] => $this->getDateCompleted(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setPay($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setMoneySpent($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDateAssigned($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDateCompleted($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_ID)) {
            $criteria->add(CircuitPlayerTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_ACTIVE)) {
            $criteria->add(CircuitPlayerTableMap::COL_ACTIVE, $this->active);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_GAME_ID)) {
            $criteria->add(CircuitPlayerTableMap::COL_GAME_ID, $this->game_id);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_PLAYER_ID)) {
            $criteria->add(CircuitPlayerTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_TARGET_ID)) {
            $criteria->add(CircuitPlayerTableMap::COL_TARGET_ID, $this->target_id);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_PAY)) {
            $criteria->add(CircuitPlayerTableMap::COL_PAY, $this->pay);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_MONEY_SPENT)) {
            $criteria->add(CircuitPlayerTableMap::COL_MONEY_SPENT, $this->money_spent);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_DATE_ASSIGNED)) {
            $criteria->add(CircuitPlayerTableMap::COL_DATE_ASSIGNED, $this->date_assigned);
        }
        if ($this->isColumnModified(CircuitPlayerTableMap::COL_DATE_COMPLETED)) {
            $criteria->add(CircuitPlayerTableMap::COL_DATE_COMPLETED, $this->date_completed);
        }
    ...
    {
        $criteria = ChildCircuitPlayerQuery::create();
        $criteria->add(CircuitPlayerTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CircuitPlayer (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CircuitPlayer Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGame(ConnectionInterface $con = null)
    {
        if ($this->aGame === null && ($this->game_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGame->addCircuitPlayers($this);
             */
        }
    ...
    public function setPlayer(ChildUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCircuitPlayerRelatedByPlayerId($this);
        }
    ...
    public function getPlayer(ConnectionInterface $con = null)
    {
        if ($this->aPlayer === null && ($this->player_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlayer->addCircuitPlayersRelatedByPlayerId($this);
             */
        }
    ...
    public function setTarget(ChildUser $v = null)
    {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addCircuitPlayerRelatedByTargetId($this);
        }
    ...
    public function getTarget(ConnectionInterface $con = null)
    {
        if ($this->aTarget === null && ($this->target_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTarget->addCircuitPlayersRelatedByTargetId($this);
             */
        }
    ...
    {
        if (null !== $this->aGame) {
            $this->aGame->removeCircuitPlayer($this);
        }
        if (null !== $this->aPlayer) {
            $this->aPlayer->removeCircuitPlayerRelatedByPlayerId($this);
        }
        if (null !== $this->aTarget) {
            $this->aTarget->removeCircuitPlayerRelatedByTargetId($this);
        }
        $this->id = null;
        $this->active = null;
        $this->game_id = null;
    ...
    {
        return (string) $this->exportTo(CircuitPlayerTableMap::DEFAULT_STRING_FORMAT);
    }
