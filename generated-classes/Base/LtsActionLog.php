...
/**
 * Base class that represents a row from the 'lts_action_logs' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class LtsActionLog implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LtsActionLogTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildLtsGame[] Cross Collection to store aggregation of ChildLtsGame objects.
     */
    ...
    /**
     * Initializes internal state of Base\LtsActionLog object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>LtsActionLog</code> instance.  If
     * <code>obj</code> is an instance of <code>LtsActionLog</code>, delegates to
     * <code>equals(LtsActionLog)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LtsActionLog The current object, for fluid interface
     */
     ...
     * @return $this|\LtsActionLog The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LtsActionLogTableMap::COL_ID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[LtsActionLogTableMap::COL_DATE] = true;
            }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[LtsActionLogTableMap::COL_TYPE] = true;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[LtsActionLogTableMap::COL_ACTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LtsActionLogTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LtsActionLogTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LtsActionLogTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LtsActionLogTableMap::translateFieldName('Action', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = LtsActionLogTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LtsActionLog'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLtsActionLogQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LtsActionLog::setDeleted()
     * @see LtsActionLog::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLtsActionLogQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LtsActionLogTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->ltsGamesScheduledForDeletion !== null) {
                if (!$this->ltsGamesScheduledForDeletion->isEmpty()) {
                    $pks = array();
                    foreach ($this->ltsGamesScheduledForDeletion as $entry) {
                        $entryPk = [];
            ...
            if ($this->collLtsGames) {
                foreach ($this->collLtsGames as $ltsGame) {
                    if (!$ltsGame->isDeleted() && ($ltsGame->isNew() || $ltsGame->isModified())) {
                        $ltsGame->save($con);
                    }
                }
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LtsActionLogTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_ACTION)) {
            $modifiedColumns[':p' . $index++]  = '`action`';
        }

        $sql = sprintf(
            'INSERT INTO `lts_action_logs` (%s) VALUES (%s)',
    ...
    {
        $pos = LtsActionLogTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LtsActionLog'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LtsActionLog'][$this->hashCode()] = true;
        $keys = LtsActionLogTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDate(),
            $keys[2] => $this->getType(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LtsActionLogTableMap::COL_ID)) {
            $criteria->add(LtsActionLogTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_DATE)) {
            $criteria->add(LtsActionLogTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_TYPE)) {
            $criteria->add(LtsActionLogTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(LtsActionLogTableMap::COL_ACTION)) {
            $criteria->add(LtsActionLogTableMap::COL_ACTION, $this->action);
        }
    ...
    {
        $criteria = ChildLtsActionLogQuery::create();
        $criteria->add(LtsActionLogTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LtsActionLog (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LtsActionLog Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLtsActionLog is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLtsActionLog The current object (for fluent API support)
     */
    public function setLtsGameActionLogs(Collection $ltsGameActionLogs, ConnectionInterface $con = null)
    {
        ...
        foreach ($ltsGameActionLogsToDelete as $ltsGameActionLogRemoved) {
            $ltsGameActionLogRemoved->setLtsActionLog(null);
        }
    ...
    protected function doAddLtsGameActionLog(ChildLtsGameActionLog $ltsGameActionLog)
    {
        ...
        $ltsGameActionLog->setLtsActionLog($this);
    }
    ...
    public function removeLtsGameActionLog(ChildLtsGameActionLog $ltsGameActionLog)
    {
        if ($this->getLtsGameActionLogs()->contains($ltsGameActionLog)) {
            ...
            $ltsGameActionLog->setLtsActionLog(null);
        }
     ...
     * Otherwise if this LtsActionLog is new, it will return
     * an empty collection; or if this LtsActionLog has previously
     * been saved, it will retrieve related LtsGameActionLogs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LtsActionLog.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildLtsGameActionLog[] List of ChildLtsGameActionLog objects
     */
    public function getLtsGameActionLogsJoinLtsGame(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildLtsGameActionLogQuery::create(null, $criteria);
    ...
    /**
     * Initializes the collLtsGames crossRef collection.
     *
     * By default this just sets the collLtsGames collection to an empty collection (like clearLtsGames());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @return void
     */
    public function initLtsGames()
    {
        $collectionClassName = LtsGameActionLogTableMap::getTableMap()->getCollectionClassName();
    ...
    /**
     * Checks if the collLtsGames collection is loaded.
     *
     * @return bool
     */
    public function isLtsGamesLoaded()
    {
        return null !== $this->collLtsGames;
    }

    /**
     * Gets a collection of ChildLtsGame objects related by a many-to-many relationship
    ...
    /**
     * Sets a collection of LtsGame objects related by a many-to-many relationship
     * to the current object by way of the lts_game_action_logs cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        $this->clearLtsGames();
        $currentLtsGames = $this->getLtsGames();

        $ltsGamesScheduledForDeletion = $currentLtsGames->diff($ltsGames);

        foreach ($ltsGamesScheduledForDeletion as $toDelete) {
            $this->removeLtsGame($toDelete);
        }

        foreach ($ltsGames as $ltsGame) {
            if (!$currentLtsGames->contains($ltsGame)) {
                $this->doAddLtsGame($ltsGame);
            }
        }
    ...
    /**
     * Gets the number of LtsGame objects related by a many-to-many relationship
     * to the current object by way of the lts_game_action_logs cross-reference table.
     *
     * @param      Criteria $criteria Optional query object to filter the query
     ...
     * @param      ConnectionInterface $con Optional connection object
     *
     * @return int the number of related LtsGame objects
     */
    ...
    /**
     * Associate a ChildLtsGame to this object
     * through the lts_game_action_logs cross reference table.
     * 
     * @param ChildLtsGame $ltsGame
     * @return ChildLtsActionLog The current object (for fluent API support)
     */
    public function addLtsGame(ChildLtsGame $ltsGame)
    {
        ...
        if (!$this->getLtsGames()->contains($ltsGame)) {
            ...
            $this->collLtsGames->push($ltsGame);
            $this->doAddLtsGame($ltsGame);
        }
    ...
    protected function doAddLtsGame(ChildLtsGame $ltsGame)
    {
        ...
        $ltsGameActionLog->setLtsGame($ltsGame);
        ...
        if (!$ltsGame->isLtsActionLogsLoaded()) {
            $ltsGame->initLtsActionLogs();
            $ltsGame->getLtsActionLogs()->push($this);
        } elseif (!$ltsGame->getLtsActionLogs()->contains($this)) {
            $ltsGame->getLtsActionLogs()->push($this);
        }
    ...
    {
        if ($this->getLtsGames()->contains($ltsGame)) { $ltsGameActionLog = new ChildLtsGameActionLog();

            $ltsGameActionLog->setLtsGame($ltsGame);
            if ($ltsGame->isLtsActionLogsLoaded()) {
                //remove the back reference if available
                $ltsGame->getLtsActionLogs()->removeObject($this);
            }
            ...
            $this->collLtsGames->remove($this->collLtsGames->search($ltsGame));
            ...
            $this->ltsGamesScheduledForDeletion->push($ltsGame);
        }
    ...
    {
        return (string) $this->exportTo(LtsActionLogTableMap::DEFAULT_STRING_FORMAT);
    }
